...
//Dua thong tin cac truong ra theo y:
                    global $post;
                  $trongtai = get_post_meta( $post->ID, 'trongtai', true );//goi bien ra
                  $dungtichxilanh = get_post_meta( $post->ID, 'dungtichxilanh', true );//goi bien ra

                    if($trongtai!= NULL){
                        echo "<p><span class='custt'>Giá công bố: </span>".$trongtai."</p>";
                    }
                    else{

                    }
                    if($dungtichxilanh!= NULL){
                        echo "<p><span class='custt'>Giá Bán: </span>".$dungtichxilanh."</p>";
                    }
                    else{
